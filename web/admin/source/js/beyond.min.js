...
function InitiateSideMenu() {
    ...
    if(readCookie('uii-setting-sidebar')=='true'){
    ...
    $("#sidebar-collapse").on("click", function() {
        ...
        createCookie("uii-setting-sidebar", $("#sidebar-collapse").hasClass('active'), 100);

        //console.log(readCookie('uii-setting-sidebar'));
...
$("#skin-changer li a").click(function() {
    createCookie("current-skin", $(this).attr("data-rel"), 10);
