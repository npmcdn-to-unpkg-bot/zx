...
CREATE TABLE `zx_signup` (
  ...
  `st` tinyint(2) DEFAULT NULL COMMENT '状态',
  `info` text COMMENT '额外数据',
  `created_at` varchar(20) DEFAULT NULL COMMENT '创建时间',
  `updated_at` varchar(20) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='报名数据表';

-- ----------------------------
-- Records of zx_signup
-- ----------------------------
INSERT INTO `zx_signup` VALUES ('1', '1', 'openid', 'lurongze', '13828447640', '37', '1', '33', '2', 'info', '1468490064', '1468490064');
...
-- ----------------------------
INSERT INTO `zx_signupset` VALUES ('7', '1', '37', 'lulu', '2016-08-01 00:00', '2016-08-24 13:55', '123123', null, '1472018137', '1472025144', null);
